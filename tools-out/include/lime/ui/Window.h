...
class HXCPP_CLASS_ATTRIBUTES Window_obj : public ::hx::Object
{
	...
	public:
		...
		int id;
		 ...
		 ::lime::app::_Event_Void_Void onlyUpdate;
		...
		int _hx___maxWidth;
		int _hx___maxHeight;
		bool _hx___lockRender;
		int _hx___drawFrameRate;
		...
		::Dynamic showFallbackOverlay_dyn();

		void hideFallbackOverlay();
		::Dynamic hideFallbackOverlay_dyn();

		void setFallbackOverlayBitmap(::Array< int > pixels,int width,int height);
		::Dynamic setFallbackOverlayBitmap_dyn();

		void captureFallbackSnapshot();
		::Dynamic captureFallbackSnapshot_dyn();
		...
		bool get_lockRender();
		::Dynamic get_lockRender_dyn();

		bool set_lockRender(bool value);
		::Dynamic set_lockRender_dyn();

		int get_drawFrameRate();
		::Dynamic get_drawFrameRate_dyn();

		int set_drawFrameRate(int value);
		::Dynamic set_drawFrameRate_dyn();
