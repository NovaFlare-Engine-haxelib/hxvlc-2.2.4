...
HX_DECLARE_STACK_FRAME(_hx_pos_cef4a471e9b9c478_829_new)
...
HXLINE( 830)		( ( ::lime::_internal::backend::native::KeyEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 831)		( ( ::lime::_internal::backend::native::KeyEventInfo)(__this) )->windowID = windowID;
HXLINE( 832)		( ( ::lime::_internal::backend::native::KeyEventInfo)(__this) )->keyCode = keyCode;
HXLINE( 833)		( ( ::lime::_internal::backend::native::KeyEventInfo)(__this) )->modifier = modifier;
            	}
