...
HX_DECLARE_STACK_FRAME(_hx_pos_1a94701d58bd3d3e_695_new)
...
class HXCPP_CLASS_ATTRIBUTES ApplicationEventInfo_obj : public ::hx::Object
{
	...
	public:
		...
		void __construct( ::Dynamic type,::hx::Null< Float >  __o_deltaTime);
		...
		inline static ::hx::ObjectPtr< ApplicationEventInfo_obj > __new( ::Dynamic type,::hx::Null< Float >  __o_deltaTime) {
			::hx::ObjectPtr< ApplicationEventInfo_obj > __this = new ApplicationEventInfo_obj();
			__this->__construct(type,__o_deltaTime);
			return __this;
		}

		inline static ::hx::ObjectPtr< ApplicationEventInfo_obj > __alloc(::hx::Ctx *_hx_ctx, ::Dynamic type,::hx::Null< Float >  __o_deltaTime) {
...
HXLINE( 696)		( ( ::lime::_internal::backend::native::ApplicationEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 697)		( ( ::lime::_internal::backend::native::ApplicationEventInfo)(__this) )->deltaTime = deltaTime;
            	}
