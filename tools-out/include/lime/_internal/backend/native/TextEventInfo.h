...
HX_DECLARE_STACK_FRAME(_hx_pos_48b909785036aaec_947_new)
...
HXLINE( 948)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 949)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->windowID = windowID;
HXLINE( 950)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->text = text;
HXLINE( 951)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->start = start;
HXLINE( 952)		( ( ::lime::_internal::backend::native::TextEventInfo)(__this) )->length = length;
            	}
