...
HX_DECLARE_STACK_FRAME(_hx_pos_21cd05885e6e0032_796_new)
...
HXLINE( 797)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 798)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->id = id;
HXLINE( 799)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->index = index;
HXLINE( 800)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->eventValue = value;
HXLINE( 801)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->x = x;
HXLINE( 802)		( ( ::lime::_internal::backend::native::JoystickEventInfo)(__this) )->y = y;
            	}
