...
HX_DECLARE_STACK_FRAME(_hx_pos_a21879e7650910f2_738_new)
...
HXLINE( 739)		( ( ::lime::_internal::backend::native::DropEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 740)		( ( ::lime::_internal::backend::native::DropEventInfo)(__this) )->file = file;
            	}
