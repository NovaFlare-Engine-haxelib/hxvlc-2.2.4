...
HX_DECLARE_STACK_FRAME(_hx_pos_60e5fd49cce3a06e_918_new)
...
HXLINE( 919)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 920)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->id = id;
HXLINE( 921)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->x = x;
HXLINE( 922)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->y = y;
HXLINE( 923)		( ( ::lime::_internal::backend::native::SensorEventInfo)(__this) )->z = z;
            	}
