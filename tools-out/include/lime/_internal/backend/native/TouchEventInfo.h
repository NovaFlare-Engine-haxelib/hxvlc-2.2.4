...
HX_DECLARE_STACK_FRAME(_hx_pos_dc6fd8f0bbdab31a_979_new)
...
HXLINE( 980)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 981)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->x = x;
HXLINE( 982)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->y = y;
HXLINE( 983)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->id = id;
HXLINE( 984)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->dx = dx;
HXLINE( 985)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->dy = dy;
HXLINE( 986)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->pressure = pressure;
HXLINE( 987)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->device = device;
            	}
