...
HX_DECLARE_STACK_FRAME(_hx_pos_3eb566585b06ea2e_861_new)
...
HXLINE( 862)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 863)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->windowID = 0;
HXLINE( 864)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->x = x;
HXLINE( 865)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->y = y;
HXLINE( 866)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->button = button;
HXLINE( 867)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->movementX = movementX;
HXLINE( 868)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->movementY = movementY;
HXLINE( 869)		( ( ::lime::_internal::backend::native::MouseEventInfo)(__this) )->clickCount = clickCount;
            	}
