...
class HXCPP_CLASS_ATTRIBUTES NativeWindow_obj : public ::hx::Object
{
	...
	public:
		...
		Float contextCreate();
		::Dynamic contextCreate_dyn();

		void contextMakeCurrentCustom(Float context);
		::Dynamic contextMakeCurrentCustom_dyn();
		...
		bool setLockRender(bool value);
		::Dynamic setLockRender_dyn();

		Float setDrawFrameRate(Float value);
		::Dynamic setDrawFrameRate_dyn();
