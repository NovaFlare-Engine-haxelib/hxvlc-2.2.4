...
HX_DECLARE_STACK_FRAME(_hx_pos_d8a53269ce4a50a3_1013_new)
...
HXLINE(1014)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->type = ( (int)(type) );
HXLINE(1015)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->windowID = windowID;
HXLINE(1016)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->width = width;
HXLINE(1017)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->height = height;
HXLINE(1018)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->x = x;
HXLINE(1019)		( ( ::lime::_internal::backend::native::WindowEventInfo)(__this) )->y = y;
            	}
