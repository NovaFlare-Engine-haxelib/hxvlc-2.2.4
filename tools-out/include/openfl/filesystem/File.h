...
class HXCPP_CLASS_ATTRIBUTES File_obj : public  ::openfl::net::FileReference_obj
{
	...
	public:
		...
		static void __boot();
		static  ::openfl::utils::ByteArrayData getFileBytes(::String path);
		static ::Dynamic getFileBytes_dyn();

		static ::String getFileText(::String path);
		static ::Dynamic getFileText_dyn();

		static void saveBytes(::String path, ::openfl::utils::ByteArrayData bytes);
		static ::Dynamic saveBytes_dyn();

		static void saveText(::String path,::String text);
		static ::Dynamic saveText_dyn();
