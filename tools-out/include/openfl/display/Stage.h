...
class HXCPP_CLASS_ATTRIBUTES Stage_obj : public  ::openfl::display::DisplayObjectContainer_obj
{
	...
	public:
		...
		static bool get_supportsOrientationChange();
		static ::Dynamic get_supportsOrientationChange_dyn();
		...
		void setOrientation( ::Dynamic newOrientation);
		::Dynamic setOrientation_dyn();
		...
		void _hx___onLimeOnlyUpdate();
		::Dynamic _hx___onLimeOnlyUpdate_dyn();
		...
		void _hx___onLimeUpdate(Float deltaTime);
		...
		bool get_autoOrients();
		::Dynamic get_autoOrients_dyn();

		bool set_autoOrients(bool value);
		::Dynamic set_autoOrients_dyn();
		...
		Float set_scaleY(Float value);
		 ...
		 ::openfl::_Vector::ObjectVector get_supportedOrientations();
		::Dynamic get_supportedOrientations_dyn();
