...
class HXCPP_CLASS_ATTRIBUTES DisplayObject_obj : public  ::openfl::events::EventDispatcher_obj
{
	...
	public:
		...
		virtual void _hx___enterFrame(Float deltaTime);
		...
		void _hx___setMask( ::openfl::display::DisplayObject value);
		::Dynamic _hx___setMask_dyn();
		...
		::Dynamic get_metaData_dyn();
		 ...
		 ::Dynamic set_metaData( ::Dynamic value);
		::Dynamic set_metaData_dyn();

		 ::openfl::display::DisplayObject get_clippingLayer();
		::Dynamic get_clippingLayer_dyn();

		 ::openfl::display::DisplayObject set_clippingLayer( ::openfl::display::DisplayObject value);
		::Dynamic set_clippingLayer_dyn();
