...
HX_LOCAL_STACK_FRAME(_hx_pos_b16b96f10668b207_226_ready,"lime.app.Future","ready",0xd4cc0f7e,"lime.app.Future.ready","lime/app/Future.hx",226,0x058e0853)
...
void Future_obj::__construct( ::Dynamic work,::hx::Null< bool >  __o_useThreads){
            	...
            	HX_STACKFRAME(&_hx_pos_b16b96f10668b207_76_new)
...
HX_DEFINE_DYNAMIC_FUNC1(Future_obj,onProgress,return )
 ...
 ::lime::app::Future Future_obj::ready(::hx::Null< int >  __o_waitTime){
            	...
            	HX_STACKFRAME(&_hx_pos_b16b96f10668b207_226_ready)
HXDLIN( 226)		return ::hx::ObjectPtr<OBJ_>(this);
            	}
