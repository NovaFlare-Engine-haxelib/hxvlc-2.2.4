...
HX_LOCAL_STACK_FRAME(_hx_pos_65c657fec0b420d3_2566_setMultiThreaded,"lime._internal.backend.native.NativeOpenGLRenderContext","setMultiThreaded",0x5c60b3ad,"lime._internal.backend.native.NativeOpenGLRenderContext.setMultiThreaded","lime/_internal/backend/native/NativeOpenGLRenderContext.hx",2566,0xd33553db)
...
void NativeOpenGLRenderContext_obj::setMultiThreaded(bool enabled){
            	HX_STACKFRAME(&_hx_pos_65c657fec0b420d3_2566_setMultiThreaded)
HXDLIN(2566)		::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_set_multithreaded(enabled);
            	}


HX_DEFINE_DYNAMIC_FUNC1(NativeOpenGLRenderContext_obj,setMultiThreaded,(void))
...
::hx::Val NativeOpenGLRenderContext_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 16:
		...
		if (HX_FIELD_EQ(inName,"setMultiThreaded") ) { return ::hx::Val( setMultiThreaded_dyn() ); }
