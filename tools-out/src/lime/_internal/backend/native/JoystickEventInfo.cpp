...
HX_DEFINE_STACK_FRAME(_hx_pos_21cd05885e6e0032_796_new,"lime._internal.backend.native.JoystickEventInfo","new",0x6a2decec,"lime._internal.backend.native.JoystickEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",796,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_21cd05885e6e0032_807_clone,"lime._internal.backend.native.JoystickEventInfo","clone",0x72666ae9,"lime._internal.backend.native.JoystickEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",807,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
void JoystickEventInfo_obj::__construct( ::Dynamic type,::hx::Null< int >  __o_id,::hx::Null< int >  __o_index,::hx::Null< int >  __o_value,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_21cd05885e6e0032_796_new)
HXLINE( 797)		this->type = ( (int)(type) );
HXLINE( 798)		this->id = id;
HXLINE( 799)		this->index = index;
HXLINE( 800)		this->eventValue = value;
HXLINE( 801)		this->x = x;
HXLINE( 802)		this->y = y;
            	}
...
bool JoystickEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::JoystickEventInfo JoystickEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_21cd05885e6e0032_807_clone)
HXDLIN( 807)		return  ::lime::_internal::backend::native::JoystickEventInfo_obj::__alloc( HX_CTX ,this->type,this->id,this->index,this->eventValue,this->x,this->y);
            	}
