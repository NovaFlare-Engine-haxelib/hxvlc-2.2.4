...
HX_DEFINE_STACK_FRAME(_hx_pos_48b909785036aaec_947_new,"lime._internal.backend.native.TextEventInfo","new",0x7aff2f5b,"lime._internal.backend.native.TextEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",947,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_48b909785036aaec_957_clone,"lime._internal.backend.native.TextEventInfo","clone",0x4be06718,"lime._internal.backend.native.TextEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",957,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
void TextEventInfo_obj::__construct( ::Dynamic type,::hx::Null< int >  __o_windowID,::String text,::hx::Null< int >  __o_start,::hx::Null< int >  __o_length){
            	...
            	HX_STACKFRAME(&_hx_pos_48b909785036aaec_947_new)
HXLINE( 948)		this->type = ( (int)(type) );
HXLINE( 949)		this->windowID = windowID;
HXLINE( 950)		this->text = text;
HXLINE( 951)		this->start = start;
HXLINE( 952)		this->length = length;
            	}
...
bool TextEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::TextEventInfo TextEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_48b909785036aaec_957_clone)
HXDLIN( 957)		return  ::lime::_internal::backend::native::TextEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->text,this->start,this->length);
            	}
