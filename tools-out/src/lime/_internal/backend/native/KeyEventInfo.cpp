...
HX_DEFINE_STACK_FRAME(_hx_pos_cef4a471e9b9c478_829_new,"lime._internal.backend.native.KeyEventInfo","new",0x84b8978d,"lime._internal.backend.native.KeyEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",829,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_cef4a471e9b9c478_838_clone,"lime._internal.backend.native.KeyEventInfo","clone",0x44e9bfca,"lime._internal.backend.native.KeyEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",838,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
void KeyEventInfo_obj::__construct( ::Dynamic type,::hx::Null< int >  __o_windowID,::hx::Null< Float >  __o_keyCode,::hx::Null< int >  __o_modifier){
            	...
            	HX_STACKFRAME(&_hx_pos_cef4a471e9b9c478_829_new)
HXLINE( 830)		this->type = ( (int)(type) );
HXLINE( 831)		this->windowID = windowID;
HXLINE( 832)		this->keyCode = keyCode;
HXLINE( 833)		this->modifier = modifier;
            	}
...
bool KeyEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::KeyEventInfo KeyEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_cef4a471e9b9c478_838_clone)
HXDLIN( 838)		return  ::lime::_internal::backend::native::KeyEventInfo_obj::__alloc( HX_CTX ,this->type,this->windowID,this->keyCode,this->modifier);
            	}
