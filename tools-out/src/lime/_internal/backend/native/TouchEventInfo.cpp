...
HX_DEFINE_STACK_FRAME(_hx_pos_dc6fd8f0bbdab31a_979_new,"lime._internal.backend.native.TouchEventInfo","new",0xc006dded,"lime._internal.backend.native.TouchEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",979,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_dc6fd8f0bbdab31a_992_clone,"lime._internal.backend.native.TouchEventInfo","clone",0xa51e5e2a,"lime._internal.backend.native.TouchEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",992,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
void TouchEventInfo_obj::__construct( ::Dynamic type,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::hx::Null< int >  __o_id,::hx::Null< Float >  __o_dx,::hx::Null< Float >  __o_dy,::hx::Null< Float >  __o_pressure,::hx::Null< int >  __o_device){
            	...
            	HX_STACKFRAME(&_hx_pos_dc6fd8f0bbdab31a_979_new)
HXLINE( 980)		this->type = ( (int)(type) );
HXLINE( 981)		this->x = x;
HXLINE( 982)		this->y = y;
HXLINE( 983)		this->id = id;
HXLINE( 984)		this->dx = dx;
HXLINE( 985)		this->dy = dy;
HXLINE( 986)		this->pressure = pressure;
HXLINE( 987)		this->device = device;
            	}
...
bool TouchEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::TouchEventInfo TouchEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_dc6fd8f0bbdab31a_992_clone)
HXDLIN( 992)		return  ::lime::_internal::backend::native::TouchEventInfo_obj::__alloc( HX_CTX ,this->type,this->x,this->y,this->id,this->dx,this->dy,this->pressure,this->device);
            	}
