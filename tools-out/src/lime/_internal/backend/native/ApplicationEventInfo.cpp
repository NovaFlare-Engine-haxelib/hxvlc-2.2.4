...
HX_DEFINE_STACK_FRAME(_hx_pos_1a94701d58bd3d3e_695_new,"lime._internal.backend.native.ApplicationEventInfo","new",0xb35cdd3c,"lime._internal.backend.native.ApplicationEventInfo.new","lime/_internal/backend/native/NativeApplication.hx",695,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_1a94701d58bd3d3e_702_clone,"lime._internal.backend.native.ApplicationEventInfo","clone",0x996e0f39,"lime._internal.backend.native.ApplicationEventInfo.clone","lime/_internal/backend/native/NativeApplication.hx",702,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{

void ApplicationEventInfo_obj::__construct( ::Dynamic type,::hx::Null< Float >  __o_deltaTime){
            		Float deltaTime = __o_deltaTime.Default(0);
            	HX_STACKFRAME(&_hx_pos_1a94701d58bd3d3e_695_new)
HXLINE( 696)		this->type = ( (int)(type) );
HXLINE( 697)		this->deltaTime = deltaTime;
            	}
...
bool ApplicationEventInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::_internal::backend::native::ApplicationEventInfo ApplicationEventInfo_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_1a94701d58bd3d3e_702_clone)
HXDLIN( 702)		return  ::lime::_internal::backend::native::ApplicationEventInfo_obj::__alloc( HX_CTX ,this->type,this->deltaTime);
            	}
...
static ::hx::StorageInfo ApplicationEventInfo_obj_sMemberStorageInfo[] = {
	{::hx::fsFloat,(int)offsetof(ApplicationEventInfo_obj,deltaTime),HX_("deltaTime",25,3c,5c,f5)},
