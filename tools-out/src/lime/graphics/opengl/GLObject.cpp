...
HX_DEFINE_STACK_FRAME(_hx_pos_def54b8cacb52d8e_2619_new,"lime.graphics.opengl.GLObject","new",0x33d200eb,"lime.graphics.opengl.GLObject.new","lime/graphics/opengl/GL.hx",2619,0xa5aa2623)
HX_LOCAL_STACK_FRAME(_hx_pos_def54b8cacb52d8e_2623_fromInt,"lime.graphics.opengl.GLObject","fromInt",0x6703afb0,"lime.graphics.opengl.GLObject.fromInt","lime/graphics/opengl/GL.hx",2623,0xa5aa2623)
namespace lime{
namespace graphics{
namespace opengl{

void GLObject_obj::__construct(int id){
            	HX_STACKFRAME(&_hx_pos_def54b8cacb52d8e_2619_new)
HXDLIN(2619)		this->id = id;
            	}
...
bool GLObject_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::graphics::opengl::GLObject GLObject_obj::fromInt(int type,int id){
            	HX_GC_STACKFRAME(&_hx_pos_def54b8cacb52d8e_2623_fromInt)
HXLINE(2624)		if ((id == 0)) {
HXLINE(2624)			return null();
            		}
HXLINE(2627)		 ::hx::Object * object = ::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_object_from_id(id,type);
HXLINE(2629)		if (::hx::IsNotNull( object )) {
HXLINE(2631)			return ( ( ::Dynamic)(object) );
            		}
HXLINE(2634)		object = ::hx::DynamicPtr( ::lime::graphics::opengl::GLObject_obj::__alloc( HX_CTX ,id));
HXLINE(2635)		( ( ::Dynamic)(object) )->__SetField(HX_("ptr",ee,61,55,00),( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gl_object_register(id,type,object)) ),::hx::paccDynamic);
HXLINE(2636)		return ( ( ::Dynamic)(object) );
            	}
