...
HX_DEFINE_STACK_FRAME(_hx_pos_890299056ccc780d_35_new,"lime.graphics.ImageBuffer","new",0xb261c9e3,"lime.graphics.ImageBuffer.new","lime/graphics/ImageBuffer.hx",35,0x6475c2cd)
HX_LOCAL_STACK_FRAME(_hx_pos_890299056ccc780d_130_clone,"lime.graphics.ImageBuffer","clone",0x1504b3a0,"lime.graphics.ImageBuffer.clone","lime/graphics/ImageBuffer.hx",130,0x6475c2cd)
...
void ImageBuffer_obj::__construct( ::lime::utils::ArrayBufferView data,::hx::Null< int >  __o_width,::hx::Null< int >  __o_height,::hx::Null< int >  __o_bitsPerPixel, ::Dynamic format){
            	...
            	HX_STACKFRAME(&_hx_pos_890299056ccc780d_35_new)
HXLINE(  82)		this->graphicScale = ((Float)1.0);
HXLINE( 113)		this->data = data;
HXLINE( 114)		this->width = width;
HXLINE( 115)		this->height = height;
HXLINE( 116)		this->bitsPerPixel = bitsPerPixel;
HXLINE( 117)		int _hx_tmp;
HXDLIN( 117)		if (::hx::IsNull( format )) {
HXLINE( 117)			_hx_tmp = 0;
            		}
            		else {
HXLINE( 117)			_hx_tmp = ( (int)(format) );
            		}
HXDLIN( 117)		this->format = _hx_tmp;
HXLINE( 118)		this->premultiplied = false;
HXLINE( 119)		this->transparent = true;
            	}
...
bool ImageBuffer_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::lime::graphics::ImageBuffer ImageBuffer_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_890299056ccc780d_130_clone)
HXLINE( 131)		 ::lime::graphics::ImageBuffer buffer =  ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this->data,this->width,this->height,this->bitsPerPixel,null());
...
static ::hx::StorageInfo ImageBuffer_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsFloat,(int)offsetof(ImageBuffer_obj,graphicScale),HX_("graphicScale",c2,42,03,e9)},
