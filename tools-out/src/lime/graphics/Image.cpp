...
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1405___clipRect,"lime.graphics.Image","__clipRect",0xd30737f1,"lime.graphics.Image.__clipRect","lime/graphics/Image.hx",1405,0xc7b862ad)
...
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1535___fromFile,"lime.graphics.Image","__fromFile",0x1c2444e3,"lime.graphics.Image.__fromFile","lime/graphics/Image.hx",1535,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1648___fromImageBuffer,"lime.graphics.Image","__fromImageBuffer",0xe152fb34,"lime.graphics.Image.__fromImageBuffer","lime/graphics/Image.hx",1648,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1700_get_data,"lime.graphics.Image","get_data",0x7986ad30,"lime.graphics.Image.get_data","lime/graphics/Image.hx",1700,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1716_set_data,"lime.graphics.Image","set_data",0x27e406a4,"lime.graphics.Image.set_data","lime/graphics/Image.hx",1716,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1721_get_format,"lime.graphics.Image","get_format",0xc57a33bd,"lime.graphics.Image.get_format","lime/graphics/Image.hx",1721,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1725_set_format,"lime.graphics.Image","set_format",0xc8f7d231,"lime.graphics.Image.set_format","lime/graphics/Image.hx",1725,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1742_get_powerOfTwo,"lime.graphics.Image","get_powerOfTwo",0x62ee1df6,"lime.graphics.Image.get_powerOfTwo","lime/graphics/Image.hx",1742,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1748_set_powerOfTwo,"lime.graphics.Image","set_powerOfTwo",0x830e066a,"lime.graphics.Image.set_powerOfTwo","lime/graphics/Image.hx",1748,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1799_get_premultiplied,"lime.graphics.Image","get_premultiplied",0xc1478990,"lime.graphics.Image.get_premultiplied","lime/graphics/Image.hx",1799,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1803_set_premultiplied,"lime.graphics.Image","set_premultiplied",0xe4b5619c,"lime.graphics.Image.set_premultiplied","lime/graphics/Image.hx",1803,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1840_get_rect,"lime.graphics.Image","get_rect",0x82caa42a,"lime.graphics.Image.get_rect","lime/graphics/Image.hx",1840,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1852_get_src,"lime.graphics.Image","get_src",0x66c2929e,"lime.graphics.Image.get_src","lime/graphics/Image.hx",1852,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1857_set_src,"lime.graphics.Image","set_src",0x59c423aa,"lime.graphics.Image.set_src","lime/graphics/Image.hx",1857,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1861_get_transparent,"lime.graphics.Image","get_transparent",0xe1ee610c,"lime.graphics.Image.get_transparent","lime/graphics/Image.hx",1861,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1867_set_transparent,"lime.graphics.Image","set_transparent",0xddb9de18,"lime.graphics.Image.set_transparent","lime/graphics/Image.hx",1867,0xc7b862ad)
...
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1400_setMaxTextureSize,"lime.graphics.Image","setMaxTextureSize",0xb6e6bb1d,"lime.graphics.Image.setMaxTextureSize","lime/graphics/Image.hx",1400,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1666___isGIF,"lime.graphics.Image","__isGIF",0x6ba10e3d,"lime.graphics.Image.__isGIF","lime/graphics/Image.hx",1666,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1674___isJPG,"lime.graphics.Image","__isJPG",0x6ba35b1a,"lime.graphics.Image.__isJPG","lime/graphics/Image.hx",1674,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1684___isPNG,"lime.graphics.Image","__isPNG",0x6ba7e6e2,"lime.graphics.Image.__isPNG","lime/graphics/Image.hx",1684,0xc7b862ad)
HX_LOCAL_STACK_FRAME(_hx_pos_ef8f6e7e24e3b831_1692___isWebP,"lime.graphics.Image","__isWebP",0xcbf428e3,"lime.graphics.Image.__isWebP","lime/graphics/Image.hx",1692,0xc7b862ad)
namespace lime{
namespace graphics{
...
HX_DEFINE_DYNAMIC_FUNC9(Image_obj,threshold,return )
 ...
 ::lime::math::Rectangle Image_obj::_hx___clipRect( ::lime::math::Rectangle r){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1405___clipRect)
HXLINE(1406)		if (::hx::IsNull( r )) {
HXLINE(1406)			return null();
            		}
HXLINE(1408)		if ((r->x < 0)) {
HXLINE(1410)			 ::lime::math::Rectangle r1 = r;
HXDLIN(1410)			r1->width = (r1->width - -(r->x));
HXLINE(1411)			r->x = ( (Float)(0) );
HXLINE(1413)			if (((r->x + r->width) <= 0)) {
HXLINE(1413)				return null();
            			}
            		}
HXLINE(1416)		if ((r->y < 0)) {
HXLINE(1418)			 ::lime::math::Rectangle r2 = r;
HXDLIN(1418)			r2->height = (r2->height - -(r->y));
HXLINE(1419)			r->y = ( (Float)(0) );
HXLINE(1421)			if (((r->y + r->height) <= 0)) {
HXLINE(1421)				return null();
            			}
            		}
HXLINE(1424)		if (((r->x + r->width) >= this->width)) {
HXLINE(1426)			 ::lime::math::Rectangle r3 = r;
HXDLIN(1426)			r3->width = (r3->width - ((r->x + r->width) - ( (Float)(this->width) )));
HXLINE(1428)			if ((r->width <= 0)) {
HXLINE(1428)				return null();
            			}
            		}
HXLINE(1431)		if (((r->y + r->height) >= this->height)) {
HXLINE(1433)			 ::lime::math::Rectangle r4 = r;
HXDLIN(1433)			r4->height = (r4->height - ((r->y + r->height) - ( (Float)(this->height) )));
HXLINE(1435)			if ((r->height <= 0)) {
HXLINE(1435)				return null();
            			}
            		}
HXLINE(1438)		return r;
            	}
...
HXDLIN(1498)		if (::hx::IsNotNull( bytes )) {
HXLINE(1498)			_hx_tmp = (bytes->length == 0);
            		}
            		else {
HXLINE(1498)			_hx_tmp = true;
            		}
HXDLIN(1498)		if (_hx_tmp) {
HXLINE(1500)			return false;
            		}
HXLINE(1503)		 ::lime::graphics::ImageBuffer imageBuffer = null();
HXLINE(1506)		::cpp::Function<  ::hx::Object *  ( ::hx::Object *, ::hx::Object *) > imageBuffer1 = ::lime::_internal::backend::native::NativeCFFI_obj::lime_image_load_bytes;
HXDLIN(1506)		 ::Dynamic elements = null();
HXDLIN(1506)		 ::haxe::io::Bytes buffer = ::haxe::io::Bytes_obj::alloc(0);
HXDLIN(1506)		::cpp::VirtualArray array = null();
HXDLIN(1506)		 ::openfl::_Vector::IntVector vector = null();
HXDLIN(1506)		 ::lime::utils::ArrayBufferView view = null();
HXDLIN(1506)		 ::Dynamic len = null();
HXDLIN(1506)		 ::lime::utils::ArrayBufferView this1;
HXDLIN(1506)		if (::hx::IsNotNull( elements )) {
HXLINE(1506)			this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements,4);
            		}
            		else {
HXLINE(1506)			if (::hx::IsNotNull( array )) {
HXLINE(1506)				 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1506)				_this->byteOffset = 0;
HXDLIN(1506)				_this->length = array->get_length();
HXDLIN(1506)				_this->byteLength = (_this->length * _this->bytesPerElement);
HXDLIN(1506)				_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN(1506)				_this->copyFromArray(array,null());
HXDLIN(1506)				this1 = _this;
            			}
            			else {
HXLINE(1506)				if (::hx::IsNotNull( vector )) {
HXLINE(1506)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1506)					::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN(1506)					_this1->byteOffset = 0;
HXDLIN(1506)					_this1->length = array1->get_length();
HXDLIN(1506)					_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN(1506)					_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN(1506)					_this1->copyFromArray(array1,null());
HXDLIN(1506)					this1 = _this1;
            				}
            				else {
HXLINE(1506)					if (::hx::IsNotNull( view )) {
HXLINE(1506)						 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1506)						 ::haxe::io::Bytes srcData = view->buffer;
HXDLIN(1506)						int srcLength = view->length;
HXDLIN(1506)						int srcByteOffset = view->byteOffset;
HXDLIN(1506)						int srcElementSize = view->bytesPerElement;
HXDLIN(1506)						int elementSize = _this2->bytesPerElement;
HXDLIN(1506)						if ((view->type == _this2->type)) {
HXLINE(1506)							int srcLength1 = srcData->length;
HXDLIN(1506)							int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN(1506)							_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(1506)							_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            						}
            						else {
HXLINE(1506)							HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            						}
HXDLIN(1506)						_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN(1506)						_this2->byteOffset = 0;
HXDLIN(1506)						_this2->length = srcLength;
HXDLIN(1506)						this1 = _this2;
            					}
            					else {
HXLINE(1506)						if (::hx::IsNotNull( buffer )) {
HXLINE(1506)							 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1506)							int in_byteOffset = 0;
HXDLIN(1506)							if ((in_byteOffset < 0)) {
HXLINE(1506)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN(1506)							if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE(1506)								HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            							}
HXDLIN(1506)							int bufferByteLength = buffer->length;
HXDLIN(1506)							int elementSize1 = _this3->bytesPerElement;
HXDLIN(1506)							int newByteLength = bufferByteLength;
HXDLIN(1506)							if (::hx::IsNull( len )) {
HXLINE(1506)								newByteLength = (bufferByteLength - in_byteOffset);
HXDLIN(1506)								if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE(1506)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN(1506)								if ((newByteLength < 0)) {
HXLINE(1506)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
            							else {
HXLINE(1506)								newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN(1506)								int newRange = (in_byteOffset + newByteLength);
HXDLIN(1506)								if ((newRange > bufferByteLength)) {
HXLINE(1506)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
            							}
HXDLIN(1506)							_this3->buffer = buffer;
HXDLIN(1506)							_this3->byteOffset = in_byteOffset;
HXDLIN(1506)							_this3->byteLength = newByteLength;
HXDLIN(1506)							_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN(1506)							this1 = _this3;
            						}
            						else {
HXLINE(1506)							HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            						}
            					}
            				}
            			}
            		}
HXDLIN(1506)		imageBuffer = ( ( ::Dynamic)(imageBuffer1(::hx::DynamicPtr(bytes),::hx::DynamicPtr( ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this1,null(),null(),null(),null())))) );
HXLINE(1516)		if (::hx::IsNotNull( imageBuffer )) {
HXLINE(1518)			this->_hx___fromImageBuffer(imageBuffer);
HXLINE(1520)			if (::hx::IsNotNull( onload )) {
HXLINE(1522)				onload(::hx::ObjectPtr<OBJ_>(this));
            			}
HXLINE(1525)			return true;
            		}
HXLINE(1531)		return false;
            	}
...
bool Image_obj::_hx___fromFile(::String path, ::Dynamic onload, ::Dynamic onerror){
            	HX_GC_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1535___fromFile)
HXLINE(1576)		 ::lime::graphics::ImageBuffer buffer = null();
HXLINE(1581)		if (::lime::_hx_system::CFFI_obj::enabled) {
HXLINE(1584)			::cpp::Function<  ::hx::Object *  ( ::hx::Object *, ::hx::Object *) > buffer1 = ::lime::_internal::backend::native::NativeCFFI_obj::lime_image_load_file;
HXDLIN(1584)			 ::Dynamic elements = null();
HXDLIN(1584)			 ::haxe::io::Bytes buffer2 = ::haxe::io::Bytes_obj::alloc(0);
HXDLIN(1584)			::cpp::VirtualArray array = null();
HXDLIN(1584)			 ::openfl::_Vector::IntVector vector = null();
HXDLIN(1584)			 ::lime::utils::ArrayBufferView view = null();
HXDLIN(1584)			 ::Dynamic len = null();
HXDLIN(1584)			 ::lime::utils::ArrayBufferView this1;
HXDLIN(1584)			if (::hx::IsNotNull( elements )) {
HXLINE(1584)				this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements,4);
            			}
            			else {
HXLINE(1584)				if (::hx::IsNotNull( array )) {
HXLINE(1584)					 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1584)					_this->byteOffset = 0;
HXDLIN(1584)					_this->length = array->get_length();
HXDLIN(1584)					_this->byteLength = (_this->length * _this->bytesPerElement);
HXDLIN(1584)					_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN(1584)					_this->copyFromArray(array,null());
HXDLIN(1584)					this1 = _this;
            				}
            				else {
HXLINE(1584)					if (::hx::IsNotNull( vector )) {
HXLINE(1584)						 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1584)						::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN(1584)						_this1->byteOffset = 0;
HXDLIN(1584)						_this1->length = array1->get_length();
HXDLIN(1584)						_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN(1584)						_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN(1584)						_this1->copyFromArray(array1,null());
HXDLIN(1584)						this1 = _this1;
            					}
            					else {
HXLINE(1584)						if (::hx::IsNotNull( view )) {
HXLINE(1584)							 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1584)							 ::haxe::io::Bytes srcData = view->buffer;
HXDLIN(1584)							int srcLength = view->length;
HXDLIN(1584)							int srcByteOffset = view->byteOffset;
HXDLIN(1584)							int srcElementSize = view->bytesPerElement;
HXDLIN(1584)							int elementSize = _this2->bytesPerElement;
HXDLIN(1584)							if ((view->type == _this2->type)) {
HXLINE(1584)								int srcLength1 = srcData->length;
HXDLIN(1584)								int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN(1584)								_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN(1584)								_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            							}
            							else {
HXLINE(1584)								HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            							}
HXDLIN(1584)							_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN(1584)							_this2->byteOffset = 0;
HXDLIN(1584)							_this2->length = srcLength;
HXDLIN(1584)							this1 = _this2;
            						}
            						else {
HXLINE(1584)							if (::hx::IsNotNull( buffer2 )) {
HXLINE(1584)								 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,4);
HXDLIN(1584)								int in_byteOffset = 0;
HXDLIN(1584)								if ((in_byteOffset < 0)) {
HXLINE(1584)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN(1584)								if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE(1584)									HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            								}
HXDLIN(1584)								int bufferByteLength = buffer2->length;
HXDLIN(1584)								int elementSize1 = _this3->bytesPerElement;
HXDLIN(1584)								int newByteLength = bufferByteLength;
HXDLIN(1584)								if (::hx::IsNull( len )) {
HXLINE(1584)									newByteLength = (bufferByteLength - in_byteOffset);
HXDLIN(1584)									if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE(1584)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
HXDLIN(1584)									if ((newByteLength < 0)) {
HXLINE(1584)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
            								}
            								else {
HXLINE(1584)									newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN(1584)									int newRange = (in_byteOffset + newByteLength);
HXDLIN(1584)									if ((newRange > bufferByteLength)) {
HXLINE(1584)										HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            									}
            								}
HXDLIN(1584)								_this3->buffer = buffer2;
HXDLIN(1584)								_this3->byteOffset = in_byteOffset;
HXDLIN(1584)								_this3->byteLength = newByteLength;
HXDLIN(1584)								_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN(1584)								this1 = _this3;
            							}
            							else {
HXLINE(1584)								HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt8Array",6b,44,d5,85));
            							}
            						}
            					}
            				}
            			}
HXDLIN(1584)			buffer = ( ( ::Dynamic)(buffer1(::hx::DynamicPtr(path),::hx::DynamicPtr( ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this1,null(),null(),null(),null())))) );
            		}
HXLINE(1629)		if (::hx::IsNotNull( buffer )) {
HXLINE(1631)			this->_hx___fromImageBuffer(buffer);
HXLINE(1633)			if (::hx::IsNotNull( onload )) {
HXLINE(1635)				onload(::hx::ObjectPtr<OBJ_>(this));
            			}
HXLINE(1638)			return true;
            		}
...
void Image_obj::_hx___fromImageBuffer( ::lime::graphics::ImageBuffer buffer){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1648___fromImageBuffer)
HXLINE(1649)		this->buffer = buffer;
HXLINE(1651)		if (::hx::IsNotNull( buffer )) {
HXLINE(1653)			if ((this->width == -1)) {
HXLINE(1655)				this->width = buffer->width;
            			}
HXLINE(1658)			if ((this->height == -1)) {
HXLINE(1660)				this->height = buffer->height;
            			}
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(Image_obj,_hx___fromImageBuffer,(void))
 ...
 ::lime::utils::ArrayBufferView Image_obj::get_data(){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1700_get_data)
HXLINE(1701)		bool _hx_tmp;
HXDLIN(1701)		bool _hx_tmp1;
HXDLIN(1701)		if (::hx::IsNull( this->buffer->data )) {
HXLINE(1701)			_hx_tmp1 = (this->buffer->width > 0);
            		}
            		else {
HXLINE(1701)			_hx_tmp1 = false;
            		}
HXDLIN(1701)		if (_hx_tmp1) {
HXLINE(1701)			_hx_tmp = (this->buffer->height > 0);
            		}
            		else {
HXLINE(1701)			_hx_tmp = false;
            		}
HXLINE(1711)		return this->buffer->data;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Image_obj,get_data,return )
 ...
 ::lime::utils::ArrayBufferView Image_obj::set_data( ::lime::utils::ArrayBufferView value){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1716_set_data)
HXDLIN(1716)		return (this->buffer->data = value);
            	}
...
int Image_obj::get_format(){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1721_get_format)
HXDLIN(1721)		return this->buffer->format;
            	}
...
int Image_obj::set_format(int value){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1725_set_format)
HXLINE(1726)		if ((this->buffer->format != value)) {
HXLINE(1728)			if ((this->type->_hx_getIndex() == 1)) {
HXLINE(1731)				::lime::_internal::graphics::ImageDataUtil_obj::setFormat(::hx::ObjectPtr<OBJ_>(this),value);
            			}
            		}
HXLINE(1737)		return (this->buffer->format = value);
            	}
...
bool Image_obj::get_powerOfTwo(){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1742_get_powerOfTwo)
HXDLIN(1742)		bool _hx_tmp;
HXDLIN(1742)		if ((this->buffer->width != 0)) {
HXDLIN(1742)			_hx_tmp = ((this->buffer->width & (~(this->buffer->width) + 1)) == this->buffer->width);
            		}
            		else {
HXDLIN(1742)			_hx_tmp = false;
            		}
HXDLIN(1742)		if (_hx_tmp) {
HXLINE(1744)			if ((this->buffer->height != 0)) {
HXLINE(1744)				return ((this->buffer->height & (~(this->buffer->height) + 1)) == this->buffer->height);
            			}
            			else {
...
bool Image_obj::set_powerOfTwo(bool value){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1748_set_powerOfTwo)
HXLINE(1749)		if ((value != this->get_powerOfTwo())) {
HXLINE(1751)			int newWidth = 1;
HXLINE(1752)			int newHeight = 1;
HXLINE(1754)			while((newWidth < this->buffer->width)){
HXLINE(1756)				newWidth = (newWidth << 1);
            			}
HXLINE(1759)			while((newHeight < this->buffer->height)){
HXLINE(1761)				newHeight = (newHeight << 1);
            			}
HXLINE(1764)			bool _hx_tmp;
HXDLIN(1764)			if ((newWidth == this->buffer->width)) {
HXLINE(1764)				_hx_tmp = (newHeight == this->buffer->height);
            			}
            			else {
HXLINE(1764)				_hx_tmp = false;
            			}
HXDLIN(1764)			if (_hx_tmp) {
HXLINE(1766)				return value;
            			}
HXLINE(1769)			switch((int)(this->type->_hx_getIndex())){
            				case (int)0: {
HXLINE(1775)					::lime::_internal::graphics::ImageDataUtil_obj::resizeBuffer(::hx::ObjectPtr<OBJ_>(this),newWidth,newHeight);
            				}
            				break;
            				case (int)1: {
HXLINE(1778)					::lime::_internal::graphics::ImageDataUtil_obj::resizeBuffer(::hx::ObjectPtr<OBJ_>(this),newWidth,newHeight);
            				}
            				break;
            				case (int)2: {
            				}
...
bool Image_obj::get_premultiplied(){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1799_get_premultiplied)
HXDLIN(1799)		return this->buffer->premultiplied;
            	}
...
bool Image_obj::set_premultiplied(bool value){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1803_set_premultiplied)
HXLINE(1804)		bool _hx_tmp;
HXDLIN(1804)		if (value) {
HXLINE(1804)			_hx_tmp = !(this->buffer->premultiplied);
            		}
            		else {
...
HXLINE(1806)			switch((int)(this->type->_hx_getIndex())){
            				case (int)0: case (int)1: {
HXLINE(1813)					::lime::_internal::graphics::ImageDataUtil_obj::multiplyAlpha(::hx::ObjectPtr<OBJ_>(this));
            				}
            				break;
            				default:{
            				}
...
HXLINE(1819)			bool _hx_tmp1;
HXDLIN(1819)			if (!(value)) {
HXLINE(1819)				_hx_tmp1 = this->buffer->premultiplied;
            			}
            			else {
HXLINE(1819)				_hx_tmp1 = false;
            			}
HXDLIN(1819)			if (_hx_tmp1) {
HXLINE(1821)				if ((this->type->_hx_getIndex() == 1)) {
HXLINE(1828)					::lime::_internal::graphics::ImageDataUtil_obj::unmultiplyAlpha(::hx::ObjectPtr<OBJ_>(this));
            				}
            			}
            		}
...
HX_DEFINE_DYNAMIC_FUNC1(Image_obj,set_premultiplied,return )
 ...
 ::lime::math::Rectangle Image_obj::get_rect(){
            	HX_GC_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1840_get_rect)
HXDLIN(1840)		return  ::lime::math::Rectangle_obj::__alloc( HX_CTX ,0,0,this->width,this->height);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Image_obj,get_rect,return )
 ...
 ::Dynamic Image_obj::get_src(){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1852_get_src)
HXDLIN(1852)		return this->buffer->get_src();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Image_obj,get_src,return )
 ...
 ::Dynamic Image_obj::set_src( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1857_set_src)
HXDLIN(1857)		return this->buffer->set_src(value);
            	}
...
bool Image_obj::get_transparent(){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1861_get_transparent)
HXLINE(1862)		if (::hx::IsNull( this->buffer )) {
HXLINE(1862)			return false;
            		}
HXLINE(1863)		return this->buffer->transparent;
            	}
...
bool Image_obj::set_transparent(bool value){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1867_set_transparent)
HXLINE(1869)		if (::hx::IsNull( this->buffer )) {
HXLINE(1869)			return false;
            		}
HXLINE(1870)		return (this->buffer->transparent = value);
            	}
...
void Image_obj::setMaxTextureSize(int size){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1400_setMaxTextureSize)
HXDLIN(1400)		::lime::_internal::backend::native::NativeCFFI_obj::lime_image_set_max_texture_size(size);
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(Image_obj,setMaxTextureSize,(void))

bool Image_obj::_hx___isGIF( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1666___isGIF)
HXLINE(1667)		bool _hx_tmp;
HXDLIN(1667)		if (::hx::IsNotNull( bytes )) {
HXLINE(1667)			_hx_tmp = (bytes->length < 6);
            		}
            		else {
HXLINE(1667)			_hx_tmp = true;
            		}
HXDLIN(1667)		if (_hx_tmp) {
HXLINE(1667)			return false;
            		}
HXLINE(1669)		::String header = bytes->getString(0,6,null());
HXLINE(1670)		if ((header != HX_("GIF87a",1e,95,06,9a))) {
HXLINE(1670)			return (header == HX_("GIF89a",dc,96,06,9a));
            		}
            		else {
HXLINE(1670)			return true;
            		}
HXDLIN(1670)		return false;
            	}
...
bool Image_obj::_hx___isJPG( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1674___isJPG)
HXLINE(1675)		bool _hx_tmp;
HXDLIN(1675)		if (::hx::IsNotNull( bytes )) {
HXLINE(1675)			_hx_tmp = (bytes->length < 4);
            		}
            		else {
...
HXDLIN(1677)		bool _hx_tmp2;
HXDLIN(1677)		if ((bytes->b->__get(0) == 255)) {
HXLINE(1677)			_hx_tmp2 = (bytes->b->__get(1) == 216);
            		}
            		else {
HXLINE(1677)			_hx_tmp2 = false;
            		}
HXDLIN(1677)		if (_hx_tmp2) {
HXLINE(1677)			_hx_tmp1 = (bytes->b->__get((bytes->length - 2)) == 255);
            		}
            		else {
HXLINE(1677)			_hx_tmp1 = false;
            		}
HXDLIN(1677)		if (_hx_tmp1) {
HXLINE(1680)			return (bytes->b->__get((bytes->length - 1)) == 217);
            		}
            		else {
HXLINE(1677)			return false;
            		}
HXDLIN(1677)		return false;
            	}
...
bool Image_obj::_hx___isPNG( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1684___isPNG)
HXLINE(1685)		bool _hx_tmp;
HXDLIN(1685)		if (::hx::IsNotNull( bytes )) {
HXLINE(1685)			_hx_tmp = (bytes->length < 8);
            		}
            		else {
...
HXDLIN(1687)		bool _hx_tmp2;
HXDLIN(1687)		bool _hx_tmp3;
HXDLIN(1687)		bool _hx_tmp4;
HXDLIN(1687)		bool _hx_tmp5;
HXDLIN(1687)		bool _hx_tmp6;
HXDLIN(1687)		if ((bytes->b->__get(0) == 137)) {
HXLINE(1687)			_hx_tmp6 = (bytes->b->__get(1) == 80);
            		}
            		else {
HXLINE(1687)			_hx_tmp6 = false;
            		}
HXDLIN(1687)		if (_hx_tmp6) {
HXLINE(1687)			_hx_tmp5 = (bytes->b->__get(2) == 78);
            		}
            		else {
HXLINE(1687)			_hx_tmp5 = false;
            		}
HXDLIN(1687)		if (_hx_tmp5) {
HXLINE(1687)			_hx_tmp4 = (bytes->b->__get(3) == 71);
            		}
            		else {
HXLINE(1687)			_hx_tmp4 = false;
            		}
HXDLIN(1687)		if (_hx_tmp4) {
HXLINE(1687)			_hx_tmp3 = (bytes->b->__get(4) == 13);
            		}
            		else {
HXLINE(1687)			_hx_tmp3 = false;
            		}
HXDLIN(1687)		if (_hx_tmp3) {
HXLINE(1687)			_hx_tmp2 = (bytes->b->__get(5) == 10);
            		}
            		else {
HXLINE(1687)			_hx_tmp2 = false;
            		}
HXDLIN(1687)		if (_hx_tmp2) {
HXLINE(1687)			_hx_tmp1 = (bytes->b->__get(6) == 26);
            		}
            		else {
HXLINE(1687)			_hx_tmp1 = false;
            		}
HXDLIN(1687)		if (_hx_tmp1) {
HXLINE(1688)			return (bytes->b->__get(7) == 10);
            		}
            		else {
HXLINE(1687)			return false;
            		}
HXDLIN(1687)		return false;
            	}
...
bool Image_obj::_hx___isWebP( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_ef8f6e7e24e3b831_1692___isWebP)
HXLINE(1693)		bool _hx_tmp;
HXDLIN(1693)		if (::hx::IsNotNull( bytes )) {
HXLINE(1693)			_hx_tmp = (bytes->length < 16);
            		}
            		else {
HXLINE(1693)			_hx_tmp = true;
            		}
HXDLIN(1693)		if (_hx_tmp) {
HXLINE(1693)			return false;
            		}
HXLINE(1695)		if ((bytes->getString(0,4,null()) == HX_("RIFF",b7,20,6b,36))) {
HXLINE(1695)			return (bytes->getString(8,4,null()) == HX_("WEBP",5c,25,b6,39));
            		}
            		else {
HXLINE(1695)			return false;
            		}
HXDLIN(1695)		return false;
            	}
...
bool Image_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 16:
		...
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"setMaxTextureSize") ) { outValue = setMaxTextureSize_dyn(); return true; }
	}
	return false;
}
...
static ::String Image_obj_sStaticFields[] = {
	...
	HX_("setMaxTextureSize",3a,2e,5e,a0),
