...
void Timeline_obj::_hx___enterFrame(Float deltaTime){
...
int Timeline_obj::_hx___getNextFrame(Float deltaTime){
...
HXLINE( 263)			nextFrame = (this->_hx___currentFrame + ::Math_obj::floor((this->_hx___timeElapsed / this->_hx___frameTime)));
...
HXLINE( 320)			this->_hx___frameTime = (( (Float)(1000) ) / ( (Float)(this->frameRate) ));
HXLINE( 321)			this->_hx___timeElapsed = ( (Float)(0) );
            		}
            	}
...
::hx::Val Timeline_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 9:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"__frameTime") ) { _hx___frameTime=inValue.Cast< Float >(); return inValue; }
		if (HX_FIELD_EQ(inName,"__isPlaying") ) { _hx___isPlaying=inValue.Cast< bool >(); return inValue; }
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"__timeElapsed") ) { _hx___timeElapsed=inValue.Cast< Float >(); return inValue; }
...
static ::hx::StorageInfo Timeline_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsFloat,(int)offsetof(Timeline_obj,_hx___frameTime),HX_("__frameTime",ba,d3,a9,68)},
	...
	{::hx::fsFloat,(int)offsetof(Timeline_obj,_hx___timeElapsed),HX_("__timeElapsed",8f,80,8e,75)},
