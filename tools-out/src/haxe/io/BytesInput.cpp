...
HX_LOCAL_STACK_FRAME(_hx_pos_4561ba551b1b01c8_83_set_position,"haxe.io.BytesInput","set_position",0xafd318f5,"haxe.io.BytesInput.set_position","D:\\HaxeToolkit\\haxe\\std/haxe/io/BytesInput.hx",83,0xe0a2c987)
...
int BytesInput_obj::set_position(int p){
            	HX_STACKFRAME(&_hx_pos_4561ba551b1b01c8_83_set_position)
HXLINE(  84)		if ((p < 0)) {
HXLINE(  85)			p = 0;
            		}
            		else {
