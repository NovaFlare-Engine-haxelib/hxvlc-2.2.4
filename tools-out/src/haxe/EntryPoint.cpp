...
HX_LOCAL_STACK_FRAME(_hx_pos_5b02a7ed222cd6c8_50_wakeup,"haxe.EntryPoint","wakeup",0xf2406907,"haxe.EntryPoint.wakeup","D:\\HaxeToolkit\\haxe\\std/haxe/EntryPoint.hx",50,0x9c7639ef)
HX_LOCAL_STACK_FRAME(_hx_pos_5b02a7ed222cd6c8_59_runInMainThread,"haxe.EntryPoint","runInMainThread",0xb452d98b,"haxe.EntryPoint.runInMainThread","D:\\HaxeToolkit\\haxe\\std/haxe/EntryPoint.hx",59,0x9c7639ef)
HX_LOCAL_STACK_FRAME(_hx_pos_5b02a7ed222cd6c8_87_addThread,"haxe.EntryPoint","addThread",0x82e27f43,"haxe.EntryPoint.addThread","D:\\HaxeToolkit\\haxe\\std/haxe/EntryPoint.hx",87,0x9c7639ef)
HX_LOCAL_STACK_FRAME(_hx_pos_5b02a7ed222cd6c8_79_addThread,"haxe.EntryPoint","addThread",0x82e27f43,"haxe.EntryPoint.addThread","D:\\HaxeToolkit\\haxe\\std/haxe/EntryPoint.hx",79,0x9c7639ef)
HX_LOCAL_STACK_FRAME(_hx_pos_5b02a7ed222cd6c8_71_addThread,"haxe.EntryPoint","addThread",0x82e27f43,"haxe.EntryPoint.addThread","D:\\HaxeToolkit\\haxe\\std/haxe/EntryPoint.hx",71,0x9c7639ef)
...
HX_LOCAL_STACK_FRAME(_hx_pos_5b02a7ed222cd6c8_37_boot,"haxe.EntryPoint","boot",0x3138e7ba,"haxe.EntryPoint.boot","D:\\HaxeToolkit\\haxe\\std/haxe/EntryPoint.hx",37,0x9c7639ef)
HX_LOCAL_STACK_FRAME(_hx_pos_5b02a7ed222cd6c8_39_boot,"haxe.EntryPoint","boot",0x3138e7ba,"haxe.EntryPoint.boot","D:\\HaxeToolkit\\haxe\\std/haxe/EntryPoint.hx",39,0x9c7639ef)
HX_LOCAL_STACK_FRAME(_hx_pos_5b02a7ed222cd6c8_45_boot,"haxe.EntryPoint","boot",0x3138e7ba,"haxe.EntryPoint.boot","D:\\HaxeToolkit\\haxe\\std/haxe/EntryPoint.hx",45,0x9c7639ef)
namespace haxe{
...
void EntryPoint_obj::wakeup(){
            	HX_STACKFRAME(&_hx_pos_5b02a7ed222cd6c8_50_wakeup)
            	}
...
void EntryPoint_obj::runInMainThread( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_5b02a7ed222cd6c8_59_runInMainThread)
...
void EntryPoint_obj::addThread( ::Dynamic f){
            		...
            		void _hx_run(){
            			...
            			void _hx_run(){
            				HX_STACKFRAME(&_hx_pos_5b02a7ed222cd6c8_87_addThread)
            			}
            			HX_END_LOCAL_FUNC0((void))

            			HX_STACKFRAME(&_hx_pos_5b02a7ed222cd6c8_79_addThread)
HXLINE(  80)			f();
...
HXLINE(  87)			::sys::thread::_Thread::Thread_Impl__obj::get_events(::haxe::EntryPoint_obj::mainThread)->runPromised( ::Dynamic(new _hx_Closure_0()));
            	...
            	HX_STACKFRAME(&_hx_pos_5b02a7ed222cd6c8_71_addThread)
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_5b02a7ed222cd6c8_37_boot)
HXDLIN(  37)		mutex =  ::sys::thread::Mutex_obj::__alloc( HX_CTX );
            	}
{
            	HX_STACKFRAME(&_hx_pos_5b02a7ed222cd6c8_39_boot)
HXDLIN(  39)		mainThread = ::sys::thread::_Thread::HaxeThread_obj::current();
            	}
{
            	HX_STACKFRAME(&_hx_pos_5b02a7ed222cd6c8_45_boot)
