...
HX_LOCAL_STACK_FRAME(_hx_pos_8583fdf66db62d86_38_release,"sys.thread.Lock","release",0xd398e4a7,"sys.thread.Lock.release","D:\\HaxeToolkit\\haxe\\std/cpp/_std/sys/thread/Lock.hx",38,0x45adf9b7)
namespace sys{
namespace thread{
...
void Lock_obj::release(){
            	HX_STACKFRAME(&_hx_pos_8583fdf66db62d86_38_release)
